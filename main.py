...
def get_args_parser():
    ...
    parser.add_argument('--stage', default='chairs', type=str,
                        help='training stage')
    parser.add_argument('--image_size', default=[544, 960], type=int, nargs='+',
    ...
    parser.add_argument('--num_steps', default=200001, type=int)
    parser.add_argument('--seed', default=326, type=int)
    parser.add_argument('--summary_freq', default=100, type=int)
    parser.add_argument('--val_freq', default=400000, type=int)
    parser.add_argument('--save_ckpt_freq', default=60000, type=int)
...
def main(args):
    ...
    # model
    model = FFlow(feature_channels=args.feature_channels,
    ...
    if 'chairs' in args.val_dataset:
        ...
        if args.local_rank == 0:
            val_results.update(results_dict)
        print("val_results for chairs-optical flow are",val_results)    
    logger.write_dict(val_results)

    val_file = os.path.join(args.checkpoint_dir, 'val_results.txt') ## args.checkpoint_dir instead of desktop
    with open(val_file, 'a') as f:
        #f.write('step: %06d\n' % total_steps)
        if args.evaluate_matched_unmatched:
            metrics = ['chairs_epe', 'chairs_matched', 'chairs_unmatched',
                        ...
                        'sintel_final_s40+',
                        'kitti_epe', 'kitti_f1', 'kitti_s0_10', 'kitti_s10_40', 'kitti_s40+',
                        'chairs_1px','chairs_3px','chairs_5px','kitti15_epe','kitti15_d1',
                        'kitti15_3px'
                        ]
        else:
            metrics = ['chairs_epe', 'chairs_s0_10', 'chairs_s10_40', 'chairs_s40+',
